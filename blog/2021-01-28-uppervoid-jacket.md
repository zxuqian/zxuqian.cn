...
![包装盒](./img/uppervoid-jacket/01-包装盒.png)

### 颜色尺码

C+ 机能服有三种颜色及多种尺码，可以参考下图：

![尺码](./img/uppervoid-jacket/02-尺码.png)
...
<img alt="购买链接" src={require("./img/uppervoid-jacket/03-购买链接.png").default} width="30%" />
...
![口袋分布示意图](./img/uppervoid-jacket/04-口袋分布示意图.png)

这衣服最显眼的地方应该就是胸前这个灰色的 1 号口袋，它叫作机械心，其实它最主要的作用并不是收纳，在后边再介绍它的特色。

![机械心](./img/uppervoid-jacket/05-机械心.png)
...
![左右口袋](./img/uppervoid-jacket/06-左右口袋.png)
...
![工牌窗](./img/uppervoid-jacket/07-工牌窗.png)
...
![魔术袖兜](./img/uppervoid-jacket/D02-魔术袖兜.gif)
...
![deepvoid](./img/uppervoid-jacket/08-deepvoid.png)
...
![镭射切割透气孔.jpg](./img/uppervoid-jacket/10.5-镭射切割透气孔.jpg)

在腋下则有拉链可以直接打开进行散热。这两个部位是男生最爱出汗的地方，这样直接与外界通气之后能最大的发挥散热和排气作用。

![腋下口袋](./img/uppervoid-jacket/11-腋下口袋.png)
